  ...
  return (
    <div className="space-y-8 max-w-3xl">
      ...
      <div>
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400 dark:text-zinc-500 mb-4">
          Podłącz kalendarz, aby asystent AI mógł sprawdzać dostępność i
          automatycznie rezerwować terminy.
        </p>

        {loading ? (
          <p className="text-sm text-zinc-400 dark:text-zinc-500">Sprawdzanie...</p>
        ) : calendarConnected ? (
          ...
          <button
            ...
            className="bg-white dark:bg-brand-900 border border-zinc-200 dark:border-brand-700 text-zinc-700 dark:text-zinc-300 px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-[#f0fdfa] transition inline-flex items-center gap-2"
          >
      ...
      {/* SMS */}
      <div className="border-t border-zinc-200 dark:border-brand-700 pt-8">
        <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-1">
          Powiadomienia SMS
        </h3>
        <p className="text-sm text-zinc-500 dark:text-zinc-400 dark:text-zinc-500 mb-4">
        ...
        <div className="bg-white dark:bg-brand-900 border border-zinc-200 dark:border-brand-700 rounded-xl p-4 space-y-3">
          <p className="text-sm text-zinc-600 dark:text-zinc-400">Testuj połączenie SMS:</p>
          <div className="flex gap-2">
            <input
              placeholder="+48 123 456 789"
              value={testSmsPhone}
              onChange={(e) => setTestSmsPhone(e.target.value)}
              className="flex-1 px-4 py-2.5 border border-zinc-200 dark:border-brand-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0d9488]/30 focus:border-[#0d9488] placeholder:text-zinc-400 dark:text-zinc-500 transition"
            />
            <button
      ...
      <div className="border-t border-zinc-200 dark:border-brand-700 pt-8">
        ...
        <div className="space-y-3 text-sm text-zinc-500 dark:text-zinc-400 dark:text-zinc-500">
          <div className="bg-white dark:bg-brand-900 rounded-xl p-4">
