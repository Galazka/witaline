...
export default function SmsStatusWidget({ businessId }: Props) {
  ...
  return (
    <div className="bg-white dark:bg-brand-900 rounded-xl p-4 space-y-3">
      ...
      <div className="flex items-center justify-between">
        <span className="text-sm text-zinc-600 dark:text-zinc-300">SMS</span>
      ...
      <a href="/dashboard?tab=sms"
        className="block w-full text-center bg-[#f0fdfa] dark:bg-brand-800 text-[#0d9488] py-2 rounded-lg text-xs font-medium hover:bg-[#ccfbf1] dark:hover:bg-brand-700 transition mt-1">
