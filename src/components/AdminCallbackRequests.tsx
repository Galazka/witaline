  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        {items.map(item => (
          <div key={item.id} className={`bg-white rounded-xl border p-4 space-y-2 ${item.deleted_at ? "opacity-60 border-zinc-200" : item.handled ? "border-zinc-200 opacity-60" : "border-l-4 border-l-brand-400 border-zinc-200"}`}>
            ...
            <div className="flex gap-1 pt-1">
              {item.deleted_at ? (
                ...
                <>
                  <button onClick={() => apiAction([item.id], item.handled ? "unhandled" : "handled")} className="text-[10px] px-2 py-1 rounded bg-brand-50 text-zinc-600 hover:bg-brand-100">
