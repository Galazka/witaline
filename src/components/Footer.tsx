  ...
  return (
    <footer className="relative bg-zinc-900 text-zinc-400 border-t border-zinc-800/50 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-brand-400/2 rounded-full blur-3xl" />
      </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><a href="/#jak-dziala" className="text-zinc-400 hover:text-brand-400 transition-colors">Jak działa</a></li>
              <li><a href="/#technologia" className="text-zinc-400 hover:text-brand-400 transition-colors">Technologia</a></li>
              <li><a href="/#cennik" className="text-zinc-400 hover:text-brand-400 transition-colors">Cennik</a></li>
              <li><a href="/#faq" className="text-zinc-400 hover:text-brand-400 transition-colors">FAQ</a></li>
              <li><Link href="/oferta-indywidualna" className="text-zinc-400 hover:text-brand-400 transition-colors">Oferta Enterprise</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><Link href="/register" className="text-zinc-400 hover:text-brand-400 transition-colors">Rejestracja</Link></li>
              <li><Link href="/login" className="text-zinc-400 hover:text-brand-400 transition-colors">Logowanie</Link></li>
              <li><Link href="/blog" className="text-zinc-400 hover:text-brand-400 transition-colors">Blog</Link></li>
              <li><Link href="/regulamin" className="text-zinc-400 hover:text-brand-400 transition-colors">Regulamin</Link></li>
              <li><Link href="/polityka-prywatnosci" className="text-zinc-400 hover:text-brand-400 transition-colors">Prywatność</Link></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-500">
          ...
          <p className="flex items-center gap-3">
            <span className="flex items-center gap-1.5">
              <svg className="w-3.5 h-3.5 text-brand-400/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
