...
export function IconBuilding({ className }: IconProps): JSX.Element {
...
export function IconMessage({ className }: IconProps): JSX.Element {
...
export function IconMail({ className }: IconProps): JSX.Element {
...
export function IconDollar({ className }: IconProps): JSX.Element {
...
export function IconShield({ className }: IconProps): JSX.Element {
...
export function IconLogout({ className }: IconProps): JSX.Element {
...
export function IconMenu({ className }: IconProps): JSX.Element {
...
export function IconMessageSquare({ className }: IconProps): JSX.Element {
...
export function IconPhoneForward({ className }: IconProps): JSX.Element {
  return <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 8l2-2m0 0l-2-2m2 2H4m6 8H4m12 0l2 2m0 0l-2 2m2-2H4" /></svg>;
}

export function IconBan({ className }: IconProps): JSX.Element {
...
export function IconUser({ className }: IconProps): JSX.Element {
...
export function IconSun({ className }: IconProps): JSX.Element {
  return <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.393-.393m-12.728 0-.393.393M16.95 7.05l-.393-.393m-12.728 0-.393.393M16 12a4 4 0 11-8 0 4 4 0 018 0z" /></svg>;
}
