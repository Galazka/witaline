  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4">
      <div className="max-w-sm text-center">
        ...
        <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-1">Błąd panelu</h2>
        <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-4">Nie udało się załadować panelu administracyjnego.</p>
        <button
          onClick={reset}
