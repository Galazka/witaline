  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
        <div className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-gradient-to-br from-brand-100/30 to-brand-50/10 rounded-full blur-3xl" />
        <div className="absolute top-1/4 -left-40 w-[400px] h-[400px] bg-gradient-to-tr from-brand-50/30 to-transparent rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-[350px] h-[350px] bg-gradient-to-bl from-brand-100/20 to-transparent rounded-full blur-3xl" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[radial-gradient(ellipse_at_center,rgba(60,191,74,0.03)_0%,transparent_70%)] rounded-full" />
      </div>

      {/* === TOP BAR === */}
      <nav className="sticky top-0 z-50 bg-white/70 backdrop-blur-2xl border-b border-zinc-200/40">
        <div className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-brand-200/30 to-transparent" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden lg:flex items-center gap-1 text-sm">
              {["Jak działa", "Technologia", "Wdrożenia", "Cennik", "FAQ", "Blog", "Kontakt"].map((label, i) => (
                <a key={label} href={`#${["jak-dziala","technologia","case-studies","cennik","faq","blog","kontakt"][i]}`} className="px-3 py-2 rounded-lg text-zinc-500 hover:text-zinc-800 hover:bg-zinc-100/60 transition-all font-medium">
                  {label}
                </a>
              ))}
            </div>
          ...
          <div className="flex items-center gap-2">
            <LanguageSwitcher />
            <Link href="/login" className="hidden sm:inline-flex text-sm text-zinc-500 hover:text-zinc-800 transition-colors font-medium px-3 py-2">Zaloguj</Link>
            <Link href="/register" className="btn-primary text-sm px-4 py-2">Startowy 7 dni</Link>
            <button onClick={() => setMobileOpen(!mobileOpen)} className="lg:hidden p-2 rounded-lg hover:bg-zinc-100 text-zinc-500 transition-colors" aria-label="Menu">
        ...
        {mobileOpen && (
          <div className="lg:hidden border-t border-zinc-100 bg-white/95 backdrop-blur-xl px-4 py-4 space-y-1 text-sm animate-fade-in-down">
            {[["#jak-dziala", "Jak działa"], ["#technologia", "Technologia"], ["#case-studies", "Wdrożenia"], ["#cennik", "Cennik"], ["#faq", "FAQ"], ["#blog", "Blog"], ["#kontakt", "Kontakt"]].map(([href, label]) => (
              <a key={href} href={href} onClick={() => setMobileOpen(false)} className="block px-3 py-2.5 rounded-lg text-zinc-600 hover:bg-zinc-50 hover:text-zinc-900 font-medium transition-colors">{label}</a>
            ))}
            <div className="h-px bg-zinc-100 my-2" />
            <Link href="/login" onClick={() => setMobileOpen(false)} className="block px-3 py-2.5 rounded-lg text-zinc-600 font-medium hover:bg-zinc-50 sm:hidden">Zaloguj</Link>
          </div>
        )}
      </nav>
      ...
      <AnimatedSection className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-white via-brand-50/10 to-white pointer-events-none" />
        <div className="absolute top-1/4 -left-20 w-72 h-72 bg-brand-100/20 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 -right-20 w-96 h-96 bg-brand-50/30 rounded-full blur-3xl" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 md:pt-28 md:pb-32 relative">
          <div className="max-w-3xl mx-auto text-center">
            <AnimatedDiv delay={0}>
              <div className="inline-flex items-center gap-2 bg-white border border-brand-100/50 text-brand-700 text-xs font-semibold px-4 py-1.5 rounded-full mb-6 shadow-sm shadow-brand-500/5">
                <span className="relative flex w-2 h-2">
                  <span className="absolute inset-0 rounded-full bg-brand-400 animate-ping opacity-40" />
                  <span className="relative rounded-full bg-brand-400 w-2 h-2" />
                </span>
                Odbieramy 24/7 — wypróbuj za darmo
              </div>
            </AnimatedDiv>
            <AnimatedDiv delay={80}>
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-zinc-900 font-display tracking-tight leading-[1.05] mb-6">
            ...
            <AnimatedDiv delay={160}>
              <p className="text-base sm:text-lg md:text-xl text-zinc-500 max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            <AnimatedDiv delay={320}>
              <div className="mt-4 text-xs text-zinc-400 flex items-center justify-center gap-4">
      ...
      <AnimatedSection className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-white relative">
        <div className="max-w-3xl mx-auto text-center">
          <span className="inline-block bg-brand-100 text-brand-700 text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wider mb-4">Posłuchaj</span>
      ...
      <AnimatedSection className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-zinc-50 border-t border-zinc-100 relative overflow-hidden">
        <div className="max-w-4xl mx-auto relative">
          <div className="text-center mb-10">
            <span className="inline-block bg-brand-100 text-brand-700 text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wider mb-4">Kalkulator</span>
      ...
      <AnimatedSection className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-white border-t border-zinc-100 relative overflow-hidden">
        <div className="max-w-5xl mx-auto relative">
          <div className="text-center mb-12">
            <span className="inline-block bg-brand-100 text-brand-700 text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wider mb-4">Przenoszenie</span>
          ...
          <div className="grid md:grid-cols-4 gap-4 md:gap-6 stagger">
            {[
              ...
              <div key={item.step} className="card-lift bg-white border border-zinc-200 rounded-2xl p-6 text-center hover:border-brand-200 hover:shadow-md transition-all">
                <div className="w-12 h-12 gradient-brand-soft rounded-2xl flex items-center justify-center text-brand-600 mx-auto mb-3">{item.icon}</div>
                <div className="w-7 h-7 bg-brand-400 text-white rounded-full flex items-center justify-center text-sm font-bold mx-auto mb-3">{item.step}</div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-zinc-200">
                  ...
                  <th className="text-center py-3 px-3 bg-brand-50 text-brand-700 font-semibold rounded-t-xl">WitaLine</th>
              ...
              <tbody>
                {[
                  ...
                  <tr key={feature} className="border-b border-zinc-100 hover:bg-zinc-50/50 transition">
                    ...
                    <td className="text-center py-2.5 px-3 text-brand-600 font-semibold">{witaline}</td>
