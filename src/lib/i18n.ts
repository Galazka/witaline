...
const landingEN = {
  ...
  contact: { title: "Let's talk about your business", subtitle: "Leave your contact and we'll get back within 24h with a tailored proposal.", phone: WITALINE_PHONE_DISPLAY, phoneDesc: "Call and test the assistant", email: "witam@witaline.pl", emailDesc: "Email us", location: "Gdansk", locationDesc: "We're in PL", formCompany: "Company name", formCompanyPlaceholder: "e.g. My Company LLC", formContact: "Full name", formContactPlaceholder: "e.g. John Doe", formWebsite: "Website", formWebsiteOptional: "optional", formWebsitePlaceholder: "e.g. mycompany.com", formMessage: "Message", formMessagePlaceholder: "Describe what you need...", formSubmit: "Send inquiry", formSuccess: "Thank you!", formSuccessSub: "We'll get back within 24h." }
};
